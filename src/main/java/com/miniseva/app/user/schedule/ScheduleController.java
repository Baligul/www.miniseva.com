package com.miniseva.app.user.schedule;
...
public class ScheduleController {
    ...
    public ScheduleController(AccountService srvAccount,
    ...
    @GetMapping(value = {"/app/my-schedule/{pageNumber}", "/app/my-schedule" })
    public String getSchedulePage(HttpServletRequest request,
        ...
        Page<Schedule> schedules = repoSchedule.findByCreatedBy(userId, pageRequest);
        ...
        long numSchedule = repoSchedule.countByCreatedBy(userId);
        ...
        String baseScheduleUrl = "/app/my-schedule";
